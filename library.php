...
<?php
    ...
    function login($email_id_unsafe, $password_unsafe, $table = 'users')
    {
        ...
        if ($num_rows > 1) {
            ...
            if ($table == 'users' || $table == 'doctors' || $table == 'nurse' || $table == 'receptionist') {
  ...
  function enter_patient_info($full_name_unsafe, $age_unsafe, $phone_no_unsafe, $address_unsafe)
  {
    ...
    function appointment_booking($patient_id_unsafe, $specialist_unsafe, $medical_condition_unsafe)
    {
        ...
        $sql = "INSERT INTO appointments VALUES ($appointment_no, $patient_id, '$specialist', '$medical_condition', NULL, NULL, 'no')";
